...
export type AppBarComponentProps = React.HTMLAttributes<HTMLDivElement> &
 ...
 */
const AppBarComponent = React.forwardRef<HTMLDivElement, AppBarComponentProps>(
...
export { AppBarComponent, Toolbar, appBarVariants, toolbarVariants };